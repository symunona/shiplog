    ...
    constructor() {
        ...
        this.vue = new Vue({
            ...
            created() {
                ...
                this.page = location.hash.length ? location.hash.substr(1) : 'login'
            },
            methods: {
                route(event) {
                ...
                calculateDayList() {
                    ...
                    // Fill missing days
                    for (let id = this.firstDayId; id <= lastDayId; id = this.nextDayId(id)) {
                ...
                currentDay: {
                    handler(currentDay, lastDay) {
                        ...
                        if (dayToSave) {
                            ...
                            this.saveTheDay(dayToSave.id, dayToSaveRaw)
                        } else {
